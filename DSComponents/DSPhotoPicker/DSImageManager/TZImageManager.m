...
/// Get Album 获得相册/相册数组
- (void)getCameraRollAlbum:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSObject *))completion{
...
- (void)getAssetFromFetchResult:(id)result atIndex:(NSInteger)index allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage completion:(void (^)(NSObject *))completion {
    if ([result isKindOfClass:[PHFetchResult class]]) {
        PHFetchResult *fetchResult = (PHFetchResult *)result;
        PHAsset *asset;
        @try {
...
- (NSObject *)assetModelWithAsset:(id)asset allowPickingVideo:(BOOL)allowPickingVideo allowPickingImage:(BOOL)allowPickingImage {
//    TZAssetModel *model;
...
/// Get postImage / 获取封面图
- (void)getPostImageWithAlbumModel:(NSObject *)model completion:(void (^)(UIImage *))completion {
...
/// Get Video / 获取视频
- (NSInteger)getVideoWithAsset:(id)asset progress:(void (^)(NSError * error,CGFloat))progressBlock completion:(void (^)(AVPlayerItem * _Nullable, NSDictionary * _Nullable))completion {
    if ([asset isKindOfClass:[PHAsset class]]) {
...
- (void)cancleDownloadingVideoWithTaskId:(NSInteger)downloadTaskId{
    [[PHImageManager defaultManager] cancelImageRequest:(PHImageRequestID)downloadTaskId];
}
...
- (NSObject *)modelWithResult:(id)result name:(NSString *)name{
